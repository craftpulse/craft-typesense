...
- Documented the Pro control panel: the collections cockpit and mapping UI, the search playground and document browser, the curation manager and entry quick-pin (`docs/pro-curation.md`), the synonyms and dictionaries managers (`docs/pro-synonyms.md`), the indexing inspector (`docs/inspector.md`), relevance tuning (`docs/pro-relevance.md`), and API key management (`docs/pro-keys.md`).
